...
public class MagicLamp {
     ...
     *
     * @param wishes number of wishes to ask the generated Genie
     ...
     * @return true if both lamps have same number of available genies, demon recharges and genie limits
     */
